...
var sphere = function() {
  ...
  // var resetDir = true;
  var getVector = function(pixel) {
    var v = Math.floor(pixel / size);
    var h = pixel - v * size;
    return calculateVector(h, v);
  }
...
var VRCreateSphere = function() {

  this.tiltTurn = function (tilt, turn) {
    ry = 90 + tilt;
    rz = 180 + turn;
  ...
  this.createSphere = function(gCanvas, img) {
    ...
    tmpCtx.drawImage(img, 0, 0, 1024, 1024);
